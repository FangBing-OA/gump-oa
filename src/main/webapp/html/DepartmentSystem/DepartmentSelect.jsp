...
<body>
    ...
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="/gump-oa/html/style/images/title_arrow.gif"/> 部门查询
        </div>
    ...
    <table cellspacing="0" cellpadding="0" class="TableStyle">
       ...
       <tbody id="TableData">
	 	...
	 	<s:iterator>
				...
				<td><a onClick="return window.confirm('这将删除所有的下级部门，您确定要删除吗？')" href="DepartmentAction!deleteDep?department.depName=<s:property value="department.depName"/>">删除</a>
