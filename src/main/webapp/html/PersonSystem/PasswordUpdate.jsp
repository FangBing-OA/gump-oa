...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="../styleue/pageCommon.css" />
...
<!--显示表单内容-->
<div id=MainArea>
    <form action="../System_Userst.html">
        <div class="ItemBlock_Title1"><!-- 信息说明<DIV CLASS="ItemBlock_Title1">
        	<IMG BORDER="0" WIDTH="4" HEIGHT="7" SRC="../styleue/images/item_point.gif" /> 修改密码 </DIV>  -->
        </div>
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
					<tr height="50">
						<td width="150">
							<img border="0" width="4" height="7" src="../styleue/images/item_point.gif" />
							请输入原密码
						</td>
        ...
        <div id="InputDetailBar">
            <input type="image" src="../style/imagesve.png"/>
