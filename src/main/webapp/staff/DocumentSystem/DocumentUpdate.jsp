...
<div id=MainArea>
    <form action="da!add" method="post" enctype="multipart/form-data">
        <div class="ItemBlock_Title1"><!-- 信息说明 ult><div class="ItemBlock_Title1">
        	<img border="0" width="4" height="7" src="../style/blue/images/item_point.gif" /> 修改公文</div> 
        </div>
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <tr><td>收件人</td>
                        <td><input type="text" name="docReceiver" class="InputStyle" value="<s:property value="#request.doc.docReceiver"/>"/> 
							
						</td>
                    </tr>
                    <tr><td>主题</td>
                        <td><input type="text" name="docTitle" class="InputStyle" value="<s:property value="#request.doc.docTitle"/>"/></td>
                    </tr>
					
				
                    <tr><td>附件</td>
                        <td><input type="file" name="img" class="InputStyle" value="<s:property value="#request.doc.docContent"/>"/></td>
                    </tr>
